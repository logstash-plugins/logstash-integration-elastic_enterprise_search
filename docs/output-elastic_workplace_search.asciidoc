...
The value of the API endpoint in the form of a URL. It could be an on-premise instance like "http://workplace.company.com:3002",
or an Elastic cloud instance, for example "https://7c455f508468426cb53912be65548117.ent-search.eu-west-1.aws.cloud.es.io"
